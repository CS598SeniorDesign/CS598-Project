...
This requires no dependency checks and is used by Docker Compose's healthcheck and container orchestrators to decide
whether to restart the container. Must stay fast and have zero external dependencies to ensure containers do not
fail/restart for invalid reasons.

ReadinessCheckView
Answers: Can this instance actually serve a request right now?
Checks dependencies such as Postgres and Redis and is used by a load balancer/orchestrator to decide
